...
const popularTags = [
  ...
  { _id: "2", name: "nextjs", questions: 50 },
  { _id: "3", name: "javascript", questions: 1000 },
  { _id: "4", name: "art", questions: 430 },
  { _id: "5", name: "history", questions: 260 },
];
...
const RightSideBar = () => {
  return (
    ...
    sticky ring-0 top-0 flex h-screen w-[350px] flex-col gap-6 overflow-y-auto 
